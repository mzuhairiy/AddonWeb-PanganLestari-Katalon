...
WebUI.setText(findTestObject('Detail Allocated Kuota Page/Pop Up Update Data Item/input Allocated Kuota'), '100')

WebUI.verifyElementPresent(findTestObject('Detail Allocated Kuota Page/Pop Up Update Data Item/Warning in Keep Kuota field'), 
    0)

WebUI.verifyElementNotClickable(findTestObject('Detail Allocated Kuota Page/Pop Up Update Data Item/btn Save Pop Up Update Data Item'), 
