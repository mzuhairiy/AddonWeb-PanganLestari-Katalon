...
WebUI.verifyElementPresent(findTestObject('Allocated Kuota Page/alert Error Kuota Not Released'), 0)

WebUI.click(findTestObject('Allocated Kuota Page/btn OK di Alert Error'))

WebUI.verifyElementNotPresent(findTestObject('Allocated Kuota Page/alert Error Kuota Not Released'), 0)
